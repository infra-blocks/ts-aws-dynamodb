...
export const setTests = () => {
  suite(set.name, () => {
    test("should work with a path as lhs and a path as rhs", () => {
    ...
    test("should work with an implicit path as lhs and a path as rhs", () => {
      const attribute = "attr.path";
      const operand = "attr.operand";
      const { match, names } = matchAction({
    ...
    test("should work with an if_not_exists operand", () => {
      const attribute = "attr.path";
      const operand = "attr.operand";
      const { match, names } = matchAction({
        action: set(
    ...
    test("should be able to add an attribute as part of the assignment", () => {
      const attribute = "attr.path";
      const lhs = "attr.lhs";
      const rhs = "attr.rhs";
      const { match, names } = matchAction({
    ...
    test("should be able to add a value as part of the assignment", () => {
      const attribute = "attr.path";
      const lhs = "attr.lhs";
      const rhs = 42;
      const { match, names, values } = matchAction({
    ...
    test("should be able to add an attribute if it exists or a default value otherwise", () => {
      const attribute = "attr.path";
      const lhs = "attr.lhs";
      const rhs = "attr.rhs";
    ...
    test("should be able to subtract an attribute as part of the assignment", () => {
      const attribute = "attr.path";
      const lhs = "attr.lhs";
      const rhs = "attr.rhs";
      const { match, names } = matchAction({
    ...
    test("should be able to subtract a value as part of the assignment", () => {
      const attribute = "attr.path";
      const lhs = "attr.lhs";
      const rhs = 42;
      const { match, names, values } = matchAction({
    ...
    test("should be able to subtract an attribute if it exists or a default value otherwise", () => {
      const attribute = "attr.path";
      const lhs = "attr.lhs";
      const rhs = "attr.rhs";
      const defaultValue = 42;
