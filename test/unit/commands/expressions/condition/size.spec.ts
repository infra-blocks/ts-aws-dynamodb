...
describe("commands.expressions.condition.size", () => {
  describe(size.name, () => {
    ...
    it("should not compile with an implicit number value", () => {
    ...
    it("should not compile with an implicit boolean value", () => {
    ...
    it("should not compile with an implicit null value", () => {
