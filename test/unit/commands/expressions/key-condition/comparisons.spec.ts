...
describe("commands.expressions.key-condition.comparisons", () => {
  describe("KeyConditionComparison", () => {
    it("should not compile with 'in'", () => {
      expect(() =>
    ...
    for (const operator of operators) {
      describe(operator, () => {
        it("should not compile with size operands", () => {
  ...
  describe("between", () => {
    it("should not compile with size", () => {
      const lhs = "toto.tata";
